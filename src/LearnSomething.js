...
import Css from './Css';
import {agees, tr, Umurku} from "./Helper";
    ...
    return (
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{backgroundColor: '#eee'}} ref={ref => this.listViewRef = ref}>
        ...
        <View style={{backgroundColor: '#B42929', paddingBottom:80, paddingTop:30, alignItems: 'center', justifyContent:'center', paddingHorizontal: 40, marginBottom:80 }}>
          ...
          <View style={{paddingVertical: 20, borderRadius: 12, borderColor: '#fff', borderWidth:1, width: inMobile ? width : width*.6,
            flexDirection: inMobile ?'column': 'row', marginHorizontal: 40, alignItems:"center"}}>
            <IconExperience/>
